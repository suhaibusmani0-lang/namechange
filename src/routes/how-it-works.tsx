  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "How It Works | Legal Name Change Timeline" },
      {
        ...
        content: "A thoroughly professional, simple 4-step legal process for executing name change and Central Gazette notification smoothly.",
      },
...
const timelineBenchmarks = [
  {
    ...
    context: "During this initial phase, our documentation desk conducts a thorough analysis of your case. We draft your specialized judicial affidavit layout, cross-verify all validation parameters, and compile the necessary digital folders required to seamlessly proceed with the subsequent steps."
  },
  {
    duration: "Phase 2: Day 3 to Day 5",
    title: "Public Disclosure & Media Advertisements",
    context: "Once your legal affidavit is formally notarized, we design the required public announcement text. This notification is securely scheduled and published in two leading national and regional daily newspapers to maintain compliance with statutory public notice laws."
  },
  {
    duration: "Phase 3: Week 2 to Week 6",
    title: "Government Registry Scrutiny & Publishing",
    context: "Your complete document dossier is delivered to the Central Gazette Office counters in New Delhi. The department's verification desk performs rigorous audits on the files. Once approved, the official name change decree is compiled, indexed, and formally published in the weekly digital e-Gazette journal."
  },
  {
    duration: "Phase 4: Post-Publication",
    title: "Final Document Updates Support",
    context: "Once the e-Gazette notification is live, you can securely download your official copy. Our legal advisors then provide a structured roadmap to help you smoothly update your newly approved legal name across core document registries, including Aadhaar cards, PAN profiles, and Passports."
  }
];
    ...
    <div className="bg-slate-50 text-slate-800 antialiased font-sans">
      ...
      <section className="py-16 bg-white border-b border-slate-200/50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-sm text-slate-600 leading-relaxed font-medium">
            Navigating the rules of the Directorate of Printing can feel overwhelming. A single formatting error on your form, using an unapproved newspaper network, or an incorrect stamp duty layout can result in an automatic rejection, forcing you to start the process all over again. Our platform resolves these complexities by managing each step through a structured workflow that guarantees compliance and eliminates technical errors.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xs text-slate-300 mt-3 font-medium">
              A detailed guide to the processing times and operational phases involved in your name change validation.
            </p>
          </div>
      ...
      <section className="py-20 bg-white border-b border-slate-200/50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-sm text-slate-600 leading-relaxed font-medium">
            To maintain our high success rate, our legal processing desk runs deep data-matching filters on every application packet before it leaves our office. We double-check core attributes, identity layouts, cross-checks for spelling variations, and newspaper verification tags against the official publication manuals. This rigorous evaluation guarantees full compliance and completely eliminates formatting rejections.
          </p>
          
          <div className="grid sm:grid-cols-3 gap-6 mt-12 text-left">
            {[
              { title: "Zero Layout Vulnerability", text: "We verify the structural phrasing of your affidavit against current judicial rules to prevent language errors." },
              { title: "Compliant Media Networks", text: "We use only officially recognized national and local newspapers to ensure public notices are fully valid." },
              { title: "Direct Counter Delivery", text: "Our specialized logistics handlers manage the physical delivery to the New Delhi counters safely and efficiently." }
            ].map((assurance, index) => (
              <div key={index} className="bg-slate-50 border border-slate-200 p-5 rounded-xl">
                ...
                <p className="text-[11px] text-slate-600 mt-2 leading-relaxed font-semibold">{assurance.text}</p>
              </div>
            ))}
          </div>
        </div>
